package com.erns.fragmentlambda
...
//        }
        ...
        btnEnviarMensaje.setOnClickListener {
            val nombre = edtMensaje.text.toString()
            val persona=Persona(nombre,"")
            clickBtnEnviarMensaje(persona)
        }
    ...
    companion object {
        ...
        private lateinit var clickBtnEnviarMensaje: (Persona) -> Unit
...
//        }
@JvmStatic
fun newInstance(clickBtnEnviarMensaje: (Persona) -> Unit): BlankFragment {
    val blankFragment = BlankFragment()
    this.clickBtnEnviarMensaje = clickBtnEnviarMensaje
